...
function renderResults(finalProfile) {
    ...
    produits.forEach(produit => {
        ...
        // Tracking correct (attaché sur chaque item)
...
async function submitForm(e) {
    ...
    // Profil calculé à partir du quiz (scoreUtilisateur)
    const finalProfile = computeFinalProfile();

    // Préparer l'écran résultat (avant ou après l’API, comme tu préfères)
    ...
    const payload = {
        ...
        // temps_jeu1/2/3 : optionnel (à ajouter si tu mets des timers)
    };
